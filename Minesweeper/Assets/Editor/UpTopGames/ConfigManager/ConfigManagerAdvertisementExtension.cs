...
public static class ConfigManagerAdvertisementExtension
{
	...
	private static void AdvertisementAdColony(AdvertisementManager ads, string tab)
	{
		...
		ads.adcolony_zoneid.ios = EditorGUILayout.TextField(tab + "Zone ID", ads.adcolony_zoneid.ios);
		...
		ads.adcolony_zoneid.android = EditorGUILayout.TextField(tab + "Zone ID", ads.adcolony_zoneid.android);
	}
	...
	private static void AdvertisementPreferencesInterstitial(AdvertisementManager ads)
	{
		...
		if (ads.default_on_interstitials.Length + ads.default_off_interstitials.Length != 4)
		{
	...
	private static void AdvertisementPreferencesWidget(AdvertisementManager ads)
	{
		...
		if (ads.default_on_widgets.Length + ads.default_off_widgets.Length != 2)
		{
